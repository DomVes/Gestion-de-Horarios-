...
function editar(ID_grupo) {
  ...
  $.post(
    "../../controller/grupo.php?op=mostrar",
    { ID_grupo: ID_grupo },
    function (data) {
      data = JSON.parse(data);
      $("#ID_grupo").val(data.ID_grupo);
      $("#codigo").val(data.codigo);
      $("#numero_de_grupo").val(data.numero_de_grupo);
      $("#cantidad_de_estudiantes").val(data.cantidad_de_estudiantes);
    }
  );
...
function eliminar(ID_grupo) {
  swal(
    ...
    function (isConfirm) {
      if (isConfirm) {
        $.post(
          "../../controller/grupo.php?op=eliminar",
          { ID_grupo: ID_grupo },
          function (data) {}
        );
